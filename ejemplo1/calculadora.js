//Funcion que trabajo como manejador de evento 
...
function init(){
    ...
    var op1 = prompt('Intoduzca el primer numero:','');
    if(isNaN(op1)){
        alert("Solo numeros");
        return false;
    }
    ...
    //Creando el contenido de la apgina 
    ...
    //Preparando el manejo del evento click sobre los enlaces
